    ...
    <section class="section-checkout">
      <form action="" class="form">
        <div className='form-wrapper'>
          ...
          <div className='form-wrapper_input-group'>
            <div className='form-wrapper__input-container'>
              ...
              <input type="number" id='cel' placeholder='(14) 00000-0000' minLength={11} maxLength={11} required/>
            </div>
            <div className='form-wrapper__input-container'>
              <label htmlFor="cpf">CPF:</label>
              <input type="number" id='cpf' placeholder='333.333.333-33' minLength={11} maxLength={11} required/>
            </div>
          </div>
          <div className='form-wrapper__input-container'>
        ...
        <div className='form-wrapper'>
          ...
          <p className='form-wrapper__p'>*O pagamento será realizado somente no momento da entrega*</p>
          <div className='form-wrapper__payment-container'>
            ...
            <div className='payment-container__input-group'>
              <input type="radio" name='paymentMethod' id='debit' value='debit'/>
          ...
          <div className='form-wrapper__delivery-container'>
            ...
            <div className='form-wrapper_input-group'>
              <div className='form-wrapper__input-container'>
                ...
                <input type="number" id='cep'  maxLength={8} minLength={8} required/>
              </div>
              <div className='form-wrapper__input-container'>
        ...
        <div className='form-wrapper'>
          ...
          <div className='form-wrapper__products-container'>
            {items.map((product, i) => (
              <CartProduct key={i} { ...product } isCartProduct={false} isCheckoutProduct/>
            ))}
          </div>
