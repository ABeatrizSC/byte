...
export function ManagementSection( { title, filterPlaceholder, subtitle, itemList, onOpenProductModal, onOpenChangeProductModal, onOpenDeleteModal } ) {
    ...
    <section className='management-section'>
        ...
        <div className='management-section__controls-container'>
            ...
            <button className='controls-container__add-product-button' onClick={onOpenProductModal}>Adicionar {title}</button>
        </div>
        <div className='management-section__products-list-container'>
            ...
            <ul>
                ...
                <li key={index}>
                    <Item item={item} onOpenChangeProductModal={onOpenChangeProductModal} onOpenDeleteModal={onOpenDeleteModal} />
                </li>
                ))}
            </ul>
        </div>
